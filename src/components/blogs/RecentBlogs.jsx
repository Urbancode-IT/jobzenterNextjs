        ...
        <div className="col-lg-6">
          {recentBlogs.slice(0, 1).map((blog) => (
            <div key={blog.id}>
              ...
              <span className="badge bg-dark">{blog.tags.join(", ")}</span>
            </div>
          ))}
        </div>
        ...
        <div className="col-lg-6">
          <div className="row flex-column gap-4">
            ...
            {recentBlogs.slice(1, 3).map((blog) => (
              <div key={blog.id} className="col-md-12 d-md-flex  d-sm-block gap-3">
                <img
                  src={blog.image}
                ...
                <div>
                  ...
                  <span className="badge bg-dark small">{blog.tags.join(", ")}</span>
                </div>
              </div>
            ))}
          </div>
