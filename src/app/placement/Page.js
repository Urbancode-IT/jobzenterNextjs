...
const placementRegisterSubtext =
  "Register for placement support — fill out the form and our team will contact you with next steps, guidance, and program details.";
  ...
  return (
    <>
      ...
      <ResumeRegister
        ...
        emailVia="Placement services page Registration"
